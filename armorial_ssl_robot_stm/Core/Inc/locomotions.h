...
//	wheelFrontRight = -((-27.9557 * vx) + (18.1546 * vy) + (2.697 * vw));
	...
	*/
	...
	MOTOR_1_PWM = map(fabs(wheelFrontLeft), 0, 30, 3000, 10000);
	...
	MOTOR_2_PWM = map(fabs(wheelBottomLeft), 0, 30, 3000, 10000);
	...
	MOTOR_3_PWM = map(fabs(wheelBottomRight), 0, 30, 3000, 10000);
	...
	MOTOR_4_PWM = map(fabs(wheelFrontRight), 0, 30, 3000, 10000);
