...
#define PWM_BUZZER TIM5->CCR4

#define LEITURA_3V3 0
#define LEITURA_BATERIA 1
#define LEITURA_5V 2
#define LEITURA_8V 3
...
int main(void)
{
  ...
  // Starting timer 3 for channels 1-4 (motors)
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_1);
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_2);
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_3);
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_4);

  // Starting timer 4 channel 1 (dribble)
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, EN_M4_Pin|H1_M4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : EN_M4_Pin H1_M4_Pin */
  GPIO_InitStruct.Pin = EN_M4_Pin|H1_M4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
